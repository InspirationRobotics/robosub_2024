...
class oakCamera:
    ...
    def modelSelect(self, modelName: str):
        ...
        """
        # root = os.path.normpath("/home/inspiration/auv/auv/device/cams/models/") -- For 2023 directory
        root = os.path.normpath("/home/inspiration/2024/robosub_2024/auv/device/cams/models/") # 2024 directory to access models
